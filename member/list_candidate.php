                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="col-sm-12 mt-0 mb-4 text-end">
                                            <a href="<?php echo $base_url.'member/add_candidate.php';?>" class="btn btn-success waves-effect waves-light me-1">Add Candidate</a>
                                        </div>
                                        <div class="table-responsive">
                                            <table class="table table-centered datatable dt-responsive nowrap" data-bs-page-length="10" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>1</td>
                                                        <td><a href="javascript:void(0);" class="fw-bold">#<?php echo !empty($candidate['id'])?$candidate['id']:"";?></a> </td>
                                                        ...
                                                        <td id="tooltip-container1">
                                                            <a href="<?php echo $base_url."member/edit_candidate.php?id=".$candidate['id'];?>" class="text-primary me-1" data-bs-container="#tooltip-container1" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="mdi mdi-pencil font-size-18"></i></a>
                                                            <a href="<?php echo $base_url."member/candidate_detail.php?id=".$candidate['id'];?>" class="me-1" data-bs-container="#tooltip-container1" data-bs-toggle="tooltip" data-bs-placement="top" title="View"><i class="mdi mdi-eye font-size-18"></i></a>
