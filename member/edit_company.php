	...
	<?php include_once("../controller/company.php");
		...
		$comapny = $companyObj->getCompanyById($id);
	?>
        
	<meta charset="utf-8" />
	<title>Edit company | Huminivex Hires</title>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" type="text" placeholder="Company name" name="company_name" id="comapny_name" required="" value="<?php echo !empty($comapny['company_name'])?$comapny['company_name']:"";?>">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <label  class="col-sm-12 col-form-label" for="email">Official Email id*</label>
                                                    <div class="col-sm-12">
                                                        <input class="form-control" type="email" placeholder="example@gmail.com" name="email" id="email" required="" value="<?php echo !empty($comapny['email'])?$comapny['email']:"";?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" type="text" placeholder="9723XXXXXX" name="mobile_no" id="mobile_no" required="" value="<?php echo !empty($comapny['mobile_no'])?$comapny['mobile_no']:"";?>">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-12" for="industry_id">
                                                        <select class="form-control select2" name="industry_id" id="industry_id" required="">
                                                            <option value="">Select Industry or sector*</option>
                                                                <?php 
                                                                    $industries = $companyObj->getAllIndustries();
                                                                    ...
                                                                    if(!empty( $industries))
                                                                    {
                                                                        ...
                                                                        {
                                                                 ?>
                                                                  <option value="<?php echo $industry['id'];?>" <?php echo ( $industry['id'] == $comapny['industry_id'] )?"selected":"";?>><?php echo $industry['title'];?></option>
                                                                 <?php           
                                                                        }
                                                                    }
                                                                ?>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <select class="form-control select2" name="comapny_size" id="comapny_size" required="">
                                                            ...
                                                            <option <?php echo ($comapny['comapny_size'] == "0-10 employees")?"selected":"";?> >0-10 employees</option>
                                                            <option <?php echo ($comapny['comapny_size'] == "10-20 employees")?"selected":"";?> >10-20 employees</option>
                                                            <option <?php echo ($comapny['comapny_size'] == "20-50 employees")?"selected":"";?> >20-50 employees</option>
                                                            <option <?php echo ($comapny['comapny_size'] == "50-100 employees")?"selected":"";?> >50-100 employees</option>
                                                            <option <?php echo ($comapny['comapny_size'] == "100-200 employees")?"selected":"";?> >100-500 employees</option>
                                                            <option <?php echo ($comapny['comapny_size'] == "500-1000 employees")?"selected":"";?>  >500-1000 employees</option>
                                                            <option <?php echo ($comapny['comapny_size'] == "1000+ employees")?"selected":"";?>   >1000+ employees</option>   
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" type="text" placeholder="Location" id="example-text-input" name="location" id="location" required="" value="<?php echo !empty($comapny['location'])?$comapny['location']:"";?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" type="text" placeholder="Contact person or recruiter's point of contact" name="contact_person_name" id="contact_person_name" required="" value="<?php echo !empty($comapny['contact_person_name'])?$comapny['contact_person_name']:"";?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" type="text" placeholder="Website URL" name="website_url" id="website_url" value="<?php echo !empty($comapny['website_url'])?$comapny['website_url']:"";?>" required="">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <label  class="col-sm-12 col-form-label" for="company_over_view">Company overview and history</label>
                                                    <div class="col-sm-12">
                                                        <textarea name="company_over_view" id="company_over_view" ><?php echo !empty($comapny['company_over_view'])?$comapny['company_over_view']:"";?></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <label  class="col-sm-12 col-form-label" for="mission_value">Mission and values</label>
                                                    <div class="col-sm-12">
                                                        <input class="form-control" type="text" placeholder="Mission and values" name="mission_value" id="mission_value" required="" value="<?php echo !empty($comapny['mission_value'])?$comapny['mission_value']:"";?>">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <label  class="col-sm-12 col-form-label" for="current_job_openings">Current job openings</label>
                                                    <div class="col-sm-12">
                                                        <input class="form-control" type="number" placeholder="Current job openings" name="current_job_openings" id="current_job_openings" required="" value="<?php echo !empty($comapny['current_job_openings'])?$comapny['current_job_openings']:"";?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" type="number" min='1' max='7' placeholder="working days" name="working_days" id="working_days" required="" value="<?php echo !empty($comapny['working_days'])?$comapny['working_days']:"";?>">
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-sm-12 education-main">
                                                            ...
                                                            ?>
                                                                <?php
                                                                    ...
                                                                    {
                                                                ?>
                                                                       <div class="row mb-3 shift-wrap" id="awards">
                                                                 <?php         
                                                                    }
                                                                    else{
                                                                 ?>
                                                                ...
                                                                ?>
                                                                    <div class="col-sm-3">
                                                                        ...
                                                                        <input class="form-control" type="text" placeholder="Enter Title" id="example-text-input" name="shift_title[]" value="<?php echo $shift['title'];?>">
                                                                    </div>
                                                                    <div class="col-sm-3">
                                                                        <label  class="col-sm-12 col-form-label">Start time</label>
                                                                        <input class="form-control" type="time" placeholder="" id="example-text-input" name="shift_stime[]" name="shift_title[]" value="<?php echo $shift['stime'];?>">
                                                                    </div>
                                                                    <div class="col-sm-3">
                                                                        <label  class="col-sm-12 col-form-label">End Time</label>
                                                                        <input class="form-control" type="time" placeholder="" id="example-text-input"  name="shift_etime[]" value="<?php echo $shift['etime'];?>">
                                                                    </div>
                                                                    <div class="col-sm-3">
                                                                        ...
                                                                        <?php
                                                                            if($i>0){
                                                                         ?>       
                                                                            <button type="button" class="btn btn-danger waves-effect waves-light me-1 awards_remove_button">Remove</button>
                                                                         <?php
                                                                            }
                                                                            else{
                                                                        ?>
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <textarea  name="e_benifits" id="e_benifits" ><?php echo !empty($comapny['e_benifits'])?$comapny['e_benifits']:"";?></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <label  class="col-sm-12 col-form-label" for="company_culture">Company culture and work environment</label>
                                                    <div class="col-sm-12">
                                                        <textarea name="company_culture" id="company_culture"><?php echo !empty($comapny['company_culture'])?$comapny['company_culture']:"";?></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <label  class="col-sm-12 col-form-label">Social responsibility initiatives</label>
                                                    <div class="col-sm-12">
                                                        <textarea id="social_responsibility" name="social_responsibility"><?php echo !empty($comapny['social_responsibility'])?$comapny['social_responsibility']:"";?></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <label  class="col-sm-12 col-form-label">Diversity and inclusion policies and initiatives</label>
                                                    <div class="col-sm-12">
                                                        <textarea id="diversity_inclusion" name="diversity_inclusion" ><?php echo !empty($comapny['diversity_inclusion'])?$comapny['diversity_inclusion']:"";?></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <label  class="col-sm-12 col-form-label">Testimonials or case studies from past or current employees</label>
                                                    <div class="col-sm-12">
                                                        <textarea id="testimonials" name="testimonials" ><?php echo !empty($comapny['testimonials'])?$comapny['testimonials']:"";?></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <label  class="col-sm-12 col-form-label">Additional comments or notes</label>
                                                    <div class="col-sm-12">
                                                        <textarea id="additional_comments" name="additional_comments" ><?php echo !empty($comapny['additional_comments'])?$comapny['additional_comments']:"";?></textarea>
                                                    </div>
                                                </div>
    ...
    $(document).ready(function(){
        ...
        var Fieldwrapper1 = $('.shift-wrap:not(#awards)'); //Input field wrapper
