    ...
    <link href="<?php echo $base_url;?>dist/assets/libs/bootstrap-datepicker/css/bootstrap-datepicker.min.css" rel="stylesheet">
    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
                                    ...
                                    <form name="job_frm" id="job_frm" >
                                         ...
                                         <div class="row mb-3">
                                            ...
                                            <div class="col-sm-6 mb-2">
                                                ...
                                                <div class="col-sm-12">
                                                    <select class="form-control select2" multiple="multiple" name="skills" id="skills" required >
                                                        <option value="">Select Skills</option>
                                                        <option  <?php echo !empty($job['skills'])?(($job['skills'] == "php")?"selected":""):"";?> >php</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 mb-2">
        ...
        <script src="<?php echo $base_url;?>dist/assets/libs/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>
    <script>
