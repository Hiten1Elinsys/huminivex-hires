                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="<?php echo $base_url;?>member/list_company.php">Company</a></li>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="col-sm-12 mt-0 mb-4 text-end">
                                            <a href="<?php echo $base_url.'member/add_company.php';?>" class="btn btn-success waves-effect waves-light me-1">Add Company</a>
                                        </div>
                                                    ...
                                                    <?php
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td id="tooltip-container1">
                                                            <a href="<?php echo $base_url.'member/edit_company.php?id='. $client['id']?>" class="text-primary me-1" data-bs-container="#tooltip-container1" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="mdi mdi-pencil font-size-18"></i></a>
                                                            <a href="<?php echo $base_url.'member/comapny_detail.php?id='.$client['id'];?>" class="text-dark me-1" data-bs-container="#tooltip-container1" data-bs-toggle="tooltip" data-bs-placement="top" title="View"><i class="mdi mdi-eye font-size-18"></i></a>
