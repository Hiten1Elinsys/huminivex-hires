    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
        ...
        <div class="right-bar">
            <div data-simplebar class="h-100">
                ...
                <div class="p-4">
                    <div class="mb-2">
                        <img src="<?php echo $base_url;?>dist/assets/images/layouts/layout-1.jpg" class="img-fluid img-thumbnail" alt="layout-1">
                    </div>
                    ...
                    <div class="mb-2">
                        <img src="<?php echo $base_url;?>dist/assets/images/layouts/layout-2.jpg" class="img-fluid img-thumbnail" alt="layout-2">
                    </div>
                    <div class="form-check form-switch mb-3">
                    ...
                    <div class="mb-2">
                        <img src="<?php echo $base_url;?>dist/assets/images/layouts/layout-3.jpg" class="img-fluid img-thumbnail" alt="layout-3">
                    </div>
