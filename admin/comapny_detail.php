                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-6 mb-3">
                                                <label for="example-text-input" class="col-sm-12 col-form-label"><b>Company email</b></label>
                                                <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-6 mb-3">
                                                <label for="example-text-input" class="col-sm-12 col-form-label"><b>Company password</b></label>
                                                <div class="col-sm-12">
                                                    <?php echo !empty($company['password'])?$company['password']:"";?>
                                                </div>
                                            </div>
