    ...
    <meta charset="utf-8" />
    <title>Edit role | Huminivex Hires</title>
                                    ...
                                    <form name="role_frm" id="role_frm" >
                                        <div class="row mb-3">
                                            <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input class="form-control" type="text" placeholder="Enter Role title" name="title" id="title" value="<?php echo !empty($role['title'])?$role['title']:"";?>" required="">
                                                    </div>
                                                     <div class="col-sm-12 mt-3">
                                                        <div class="mt-4 mt-lg-0">
                                                            ...
                                                            <div class="row">
                                                                <?php 
                                                                $roleObj = new roles();
                                                                $modules = $roleObj->getAllModules();
                                                                if(!empty($modules ))
                                                                {
                                                                    foreach($modules  as $module)
                                                                    {
                                                                        $moduleIds = json_decode($role['role']);
                                                            ?>
                                                             <div class="col-sm-6">
                                                                <div class="form-check mb-3">
                                                                    <input class="form-check-input" type="checkbox" name="role[]" id="role_<?php echo !empty($module['id'])?$module['id']:"";?>" value="<?php echo !empty($module['id'])?$module['id']:"";?>" <?php echo in_array($module['id'],$moduleIds )?"checked":"";?>>
                                                                    <label class="form-check-label" for="role_<?php echo !empty($module['id'])?$module['id']:"";?>">
                                                                        <?php echo !empty($module['title'])?$module['title']:"";?>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            <?php            
